package duck.spring.itsol.filter;
...
public class JwtTokenFilters extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(@NonNull  HttpServletRequest request,
        ...
        try {
            ...
            // Authenticate if phone number and no current authentication
            ...
            // Log the exception for debugging (omitted for security reasons)
    ...
    private boolean isBypassToken(@NonNull HttpServletRequest request) {
        final List<Pair<String, String>> bypassTokens = Arrays.asList(
                ...
                Pair.of(String.format("%s/lichbay**", apiPrefix), "GET"),
                Pair.of(String.format("%s/chuyenbay**", apiPrefix), "GET"),
